...
Network_Energy_Future = (np.array(Network_Traffic_Future) / np.array(Network_Capacity_Future) * (1 - K) + K) * (
        17675608 + 43160884) / 1_000_000 * 24
Network_Energy_Before5G_low = Network_Energy_Before5G - K_std * 43160884 / 1_000_000 * 24
...
Network_Energy_Before5G_high = Network_Energy_Before5G + K_std * 43160884 / 1_000_000 * 24
...
Network_Carbon_Before5G_low = (Network_Energy_Before5G_low / 24 * gama) * 24 - gama_std * 24
Network_Carbon_After5G_low = (Network_Energy_After5G_low / 24 * gama) * 24 - gama_std * 24
Network_Carbon_Future_low = (Network_Energy_Future_low / 24 * gama) * 24 - gama_std * 24
Network_Carbon_Before5G_high = (Network_Energy_Before5G_high / 24 * gama) * 24 + gama_std * 24
Network_Carbon_After5G_high = (Network_Energy_After5G_high / 24 * gama) * 24 + gama_std * 24
Network_Carbon_Future_high = (Network_Energy_Future_high / 24 * gama) * 24 + gama_std * 24


print('Carbon Uncertainty After 5G', Network_Carbon_After5G_high-Network_Carbon_After5G_low)
...
print('Carbon Caused by 5G', Network_Carbon_After5G[0] - Network_Carbon_Before5G[-1])
...
axes.plot(Date_After5G[0:6],
          np.concatenate((Network_Carbon_Efficiency_Before5G, Network_Carbon_Efficiency_Before5G))[0:6],
          color='olivedrab', linestyle=':', linewidth=2)
axes.fill_between(Date_After5G[0:6],
                  np.concatenate((Network_Carbon_Efficiency_Before5G, Network_Carbon_Efficiency_Before5G))[0:6],
                  Network_Carbon_Efficiency_After5G[0:6], facecolor='dimgray', hatch='//', edgecolor="w",
                  linewidth=0.3,
                  alpha=0.5)
...
Misalignment_Factor_Province = {'Without Method': {}, 'Threshold-based Method': {}, 'Greedy': {}, 'DeepEnergy': {}}
Misalignment_Factor_Province_std = {'Without Method': {}, 'Threshold-based Method': {}, 'Greedy': {}, 'DeepEnergy': {}}
...
for Province in Province_Network_Capacity:
    ...
    Misalignment_Factor_Province['Without Method'][Province] = ((
                                                                    - K) * Network_Traffic_After5G / Network_Capacity_After5G + K).flatten().tolist()
    Misalignment_Factor_Province['Threshold-based Method'][Province] = ((
                                                                    - K1) * Network_Traffic_After5G / Network_Capacity_After5G + K1).flatten().tolist()
    Misalignment_Factor_Province['Greedy'][Province] = ((
                                                                    - K2) * Network_Traffic_After5G / Network_Capacity_After5G + K2).flatten().tolist()
    Misalignment_Factor_Province['DeepEnergy'][Province] = ((
                                                                    - K3) * Network_Traffic_After5G / Network_Capacity_After5G + K3).flatten().tolist()

    Misalignment_Factor_Province_std['Without Method'][Province] = (( - K) * Network_Traffic_After5G / Network_Capacity_After5G + K -
                                                        (( - (K-K_std)) * Network_Traffic_After5G / Network_Capacity_After5G + (K-K_std))).flatten().tolist()
    Misalignment_Factor_Province_std['Threshold-based Method'][Province] = (( - K1) * Network_Traffic_After5G / Network_Capacity_After5G + K1 -
                                                        (( - (K1-K1_std)) * Network_Traffic_After5G / Network_Capacity_After5G + (K1-K1_std))).flatten().tolist()
    Misalignment_Factor_Province_std['Greedy'][Province] = (( - K2) * Network_Traffic_After5G / Network_Capacity_After5G + K2 -
                                                        (( - (K2-K2_std)) * Network_Traffic_After5G / Network_Capacity_After5G + (K2-K2_std))).flatten().tolist()
    Misalignment_Factor_Province_std['DeepEnergy'][Province] = (( - K3) * Network_Traffic_After5G / Network_Capacity_After5G + K3 -
                                                        (( - (K3-K3_std)) * Network_Traffic_After5G / Network_Capacity_After5G + (K3-K3_std))).flatten().tolist()
...
np.save('./data/Misalignment_Factor_Province.npy', Misalignment_Factor_Province)
np.save('./data/Misalignment_Factor_Province_std.npy', Misalignment_Factor_Province_std)
...
plt.xlim(1, 335)
fig.legend(loc=2, bbox_to_anchor=(-0.09, 0.959), ncol=2, fontsize=20, bbox_transform=ax1.transAxes)
...
Current_Energy_Before5G = (np.array(Network_Traffic_Before5G) / np.array(
    Network_Capacity_Before5G) * 0.577 + 0.423) * 43160884 / 1_000_000 * 24
...
Network_Energy_After5G_low = Network_Energy_After5G - K_std * (
        17675608 + 43160884) / 1_000_000 * 24
Network_Energy_Future_low = Network_Energy_Future - K_std * (17675608 + 43160884) / 1_000_000 * 24
Current_Energy_Before5G_low = Current_Energy_Before5G - K1_std * 43160884 / 1_000_000 * 24
...
Mobicom_Energy_Before5G_low = Mobicom_Energy_Before5G - K2_std * 43160884 / 1_000_000 * 24
...
RL_Energy_Before5G_low = RL_Energy_Before5G - K3_std * 43160884 / 1_000_000 * 24
...
Network_Energy_Before5G_high = Network_Energy_Before5G + K_std * 43160884 / 1_000_000 * 24
Network_Energy_After5G_high = Network_Energy_After5G + K_std * (
        17675608 + 43160884) / 1_000_000 * 24
Network_Energy_Future_high = Network_Energy_Future + K_std * (
        17675608 + 43160884) / 1_000_000 * 24
Current_Energy_Before5G_high = Current_Energy_Before5G + K1_std * 43160884 / 1_000_000 * 24
Current_Energy_After5G_high = Current_Energy_After5G + K1_std * (
        17675608 + 43160884) / 1_000_000 * 24
Current_Energy_Future_high = Current_Energy_Future + K1_std * (
        17675608 + 43160884) / 1_000_000 * 24
Mobicom_Energy_Before5G_high = Mobicom_Energy_Before5G + K2_std * 43160884 / 1_000_000 * 24
Mobicom_Energy_After5G_high = Mobicom_Energy_After5G + K2_std * (
        17675608 + 43160884) / 1_000_000 * 24
Mobicom_Energy_Future_high = Mobicom_Energy_Future + K2_std * (
        17675608 + 43160884) / 1_000_000 * 24
RL_Energy_Before5G_high = RL_Energy_Before5G + K3_std * 43160884 / 1_000_000 * 24
...
Current_Carbon_Before5G_low = (Current_Energy_Before5G_low / 24 * gama) * 24 - gama_std * 24
Current_Carbon_After5G_low = (Current_Energy_After5G_low / 24 * gama) * 24 - gama_std * 24
Current_Carbon_Future_low = (Current_Energy_Future_low / 24 * gama) * 24 - gama_std * 24
Current_Carbon_Before5G_high = (Current_Energy_Before5G_high / 24 * gama) * 24 + gama_std * 24
Current_Carbon_After5G_high = (Current_Energy_After5G_high / 24 * gama) * 24 + gama_std * 24
Current_Carbon_Future_high = (Current_Energy_Future_high / 24 * gama) * 24 + gama_std * 24
...
Mobicom_Carbon_Before5G_low = (Mobicom_Energy_Before5G_low / 24 * gama) * 24 - gama_std * 24
Mobicom_Carbon_After5G_low = (Mobicom_Energy_After5G_low / 24 * gama) * 24 - gama_std * 24
Mobicom_Carbon_Future_low = (Mobicom_Energy_Future_low / 24 * gama) * 24 - gama_std * 24
Mobicom_Carbon_Before5G_high = (Mobicom_Energy_Before5G_high / 24 * gama) * 24 + gama_std * 24
Mobicom_Carbon_After5G_high = (Mobicom_Energy_After5G_high / 24 * gama) * 24 + gama_std * 24
Mobicom_Carbon_Future_high = (Mobicom_Energy_Future_high / 24 * gama) * 24 + gama_std * 24
...
RL_Carbon_Before5G_low = (RL_Energy_Before5G_low / 24 * gama) * 24 - gama_std * 24
RL_Carbon_After5G_low = (RL_Energy_After5G_low / 24 * gama) * 24 - gama_std * 24
RL_Carbon_Future_low = (RL_Energy_Future_low / 24 * gama) * 24 - gama_std * 24
RL_Carbon_Before5G_high = (RL_Energy_Before5G_high / 24 * gama) * 24 + gama_std * 24
RL_Carbon_After5G_high = (RL_Energy_After5G_high / 24 * gama) * 24 + gama_std * 24
RL_Carbon_Future_high = (RL_Energy_Future_high / 24 * gama) * 24 + gama_std * 24
...
print('Just Before 5G    ', 'Energy Efficiency', 'Carbon Efficiency')
print('W/O Energy Saving', Network_Energy_Efficiency_Before5G[-1], Network_Carbon_Efficiency_Before5G[-1])
print('DeepEnergy       ', RL_Energy_Efficiency_Before5G[-1], RL_Carbon_Efficiency_Before5G[-1])

print('Just After 5G    ', 'Energy Efficiency', 'Carbon Efficiency')
print('W/O Energy Saving', Network_Energy_Efficiency_After5G[0], Network_Carbon_Efficiency_After5G[0])
print('DeepEnergy       ', RL_Energy_Efficiency_After5G[0], RL_Carbon_Efficiency_After5G[0])
...
axes.axvline(Date_Future[0], c="purple", ls="--", alpha=0.8, lw=3)
axes.set_xticks([7, 23, 31, 42])
axes.set_xticklabels(['2021-01 (Launching 5G)', '2022-05', '2023-1', '2024-12'], fontsize=26)
axes.set_xlim(0, 31)
axes.tick_params(axis="y", labelsize=26)
axes.set_ylabel('Carbon Efficiency (TByte/tCO$_2$)', fontsize=26)
axes.set_ylim(0.9 * np.min(Network_Carbon_Efficiency_After5G), 7.2)
axes.text(Date_After5G[0] + 2, 1 * Network_Carbon_Efficiency_After5G[0], 'Carbon Efficiency Trap', fontsize=24)
plt.legend(fontsize=20, bbox_to_anchor=(-0.1, 1.3), loc=2, ncol=3)
cloud.savefig(r"fig3\Method Carbon Efficiency Temporal.pdf", format='pdf', bbox_inches='tight')
plt.close()

print('\n\t\tEnergy Efficiency from 2021-01 to 2023-01\t\t')
print('\t\t', '\t2021-01', '\t2023-01')
print('W/O Energy Saving', Network_Energy_Efficiency_After5G[0], Network_Carbon_Efficiency_Future[8])
print('DeepEnergy       ', RL_Energy_Efficiency_After5G[0], RL_Carbon_Efficiency_Future[8])
print('Gain             ', RL_Energy_Efficiency_After5G[0]-Network_Energy_Efficiency_After5G[0],
      RL_Carbon_Efficiency_Future[8]-Network_Carbon_Efficiency_Future[8])
...
def cost_calculator(PV_area, P_m, N_PV, N_B, i, d, E_L, E_m=0, num=0):
    ...
    C_MPW = 0.03 * P * (1-yita_all) / (1-yita_year)

    # 总成本加和
    cost = C_PV + C_Inv * (yita_year**10) + C_MPW
...
sen = ''
for k in range(5):
    co1, c1 = cost_calculator(area[k], P_m = 200*area[k], N_PV=20, N_B=5, i=0.035, d=0.05, E_L=1)
    if 0 <= area[k] < 5:
        a = '0'
    else:
        a = str(area[k])
    co2, c2 = cost_calculator(int(a), P_m = 200*area[k], N_PV=20, N_B=5, i=0.035, d=0.05, E_L=1)
    profit = profitcalculator(np.sum(CO[mode][''][a]['4G']+CO[mode][''][a]['5G']-CO['old']['']['0']['4G']+CO['old']['']['0']['5G']), 0)
    profit_list.append(profit)
    # cost1.append(co1*21035)
    cost1.append(co1*14243*dr)
    cost2.append(co2*14243*dr)
    clear1.append(cost1[k] * int(bool(area[k])))
    clear2.append(cost2[k] * int(bool(area[k])))
    rate1 = []
    CR = []
    for sen in CO[mode]:
        rate1.append(1-np.sum(CO[mode][sen][a]['4G']+CO[mode][sen][a]['5G'])/np.sum(CO['old'][sen]['0']['4G']+CO['old'][sen]['0']['5G']))
        CR.append((cost1[k]*7/365)/np.sum((CO['old'][sen]['0']['4G']+CO['old'][sen]['0']['5G']) - (CO[mode][sen][a]['4G']+CO[mode][sen][a]['5G'])))
...
ax1.errorbar(np.array(clear2)/1000_000, rate, color = '#9cce37', yerr = std, linewidth = 3.5,elinewidth=2,capsize=8,capthick=2)
p1, = ax1.plot(np.array(clear2)/1000_000, rate, color = '#9cce37', linewidth = 3.5, label='Net Zero Rate (W/O Energy-Saving)')
ax1.scatter(np.array(clear2)/1000_000, rate, color = '#9cce37', s=PC_list, alpha=0.6)
Carbon_Reduction[0] = Carbon_Reduction[1]/5*area[0]
ax2.errorbar(np.array(clear1)[1:]/1000_000, Carbon_Reduction[1:], color = '#ff4500', yerr = std_CR[1:], linewidth = 3.5, label = 'Carbon Reduction per Yuan (W/O Energy-Saving)',elinewidth=2,capsize=8,capthick=2)
p2 = ax2.scatter(np.array(clear1)[1:]/1000_000, Carbon_Reduction[1:], color = '#ff4500', s=150, marker='v')
print(Carbon_Reduction)
# print(rate[2] - rate[0])
# print(clear1[2])
...
for k in range(5):
    ...
    if 0 <= area[k] < 5:
        ...
        a = str(area[k])
    co2, c2 = cost_calculator(int(a), P_m = 200*area[k], N_PV=20, N_B=5, i=0.035, d=0.05, E_L=1)
    profit = profitcalculator(np.sum(CO[mode][''][a]['4G']+CO[mode][sen][a]['5G']-CO['old']['']['0']['4G']+CO['old']['']['0']['5G']), 0)
    profit_list.append(profit)
    cost1.append(co1*14243*dr)
    cost2.append(co2*14243*dr)
    clear1.append(cost1[k] * int(bool(area[k])))
    ...
    PC_list.append(np.sum(PC[mode][''][a]['4G']+PC[mode][''][a]['5G'])*2)
# print(Carbon_Reduction)
ax1.errorbar(np.array(clear2)/1000_000, rate, color = '#20B2AB', yerr = std, linewidth = 3.5,elinewidth=2,capsize=8,capthick=2)
...
Carbon_Reduction[0] = Carbon_Reduction[1]/5*area[0]
# Carbon_Reduction[0] = Carbon_Reduction[0] - (Carbon_Reduction[0] - Carbon_Reduction[1])/5*area[0]
ax2.errorbar(np.array(clear1)[1:]/1000_000, Carbon_Reduction[1:], color = '#FFBB78', linewidth = 3.5, yerr = std_CR[1:], label='Carbon Reduction per Yuan (Deep Energy)',elinewidth=2,capsize=8,capthick=2)
p4 = ax2.scatter(np.array(clear1)[1:]/1000_000, Carbon_Reduction[1:], color = '#FFBB78', s=150, marker='v')
# print(rate[2] - rate[0])


p5 = ax1.scatter(-100, 0.5, color = '#C0C0C0', s=100*8, label='100MWh PV Energy Curtailment')
# fig.legend(loc=2, bbox_to_anchor=(0.15, 1.25), ncol =2, fontsize=24, borderpad=0.9, labelspacing=1.1)
fig.legend((p1, p3, p5, p2, p4), ('Net Zero Rate (W/O Energy-Saving)', 'Net Zero Rate (DeepEnergy)', '100MWh PV Energy Curtailment', 'Levelized Cost of Carbon Abatement (W/O Energy-Saving)', 'Levelized Cost of Carbon Abatement (DeepEnergy)'), bbox_to_anchor=(0.12, 1.25), loc=2, ncol =2, fontsize=24, borderpad=0.9, labelspacing=1.1)
ax1.set_ylim(-0.05, 0.8)
ax1.set_xlim(-0.5, 14.5)
ax2.set_ylim(-15, 360)
ax1.set_ylabel('Net Zero Rate', fontsize=28)
ax2.set_ylabel('Levelized Cost of Carbon \nAbatement (CNY/tCO$_2$)', fontsize=28)
ax1.set_xlabel('Average Annual Cost of PV System (Million CNY/Year)', fontsize=28)
plt.xticks(fontsize=28)
plt.yticks(fontsize=28)
